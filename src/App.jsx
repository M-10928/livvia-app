...
function TopWave() {
  return (
    <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 110, overflow: "hidden", zIndex: 0 }}>
      <div style={{ width: "160%", height: 200, background: C.teal, borderRadius: "0 0 50% 50%", marginLeft: "-30%", opacity: 0.95 }} />
    </div>
  );
}
function BottomWave() {
...
export default function LivviaApp() {
  ...
  if (screen === "login") return (
    <div style={{ minHeight: "100vh", background: C.white, fontFamily: "'Nunito', 'Helvetica Neue', sans-serif", display: "flex", flexDirection: "column", alignItems: "center", maxWidth: 390, margin: "0 auto", position: "relative", overflow: "hidden" }}>
      <TopWave />
      <div style={{ position: "relative", zIndex: 1, width: "100%", padding: "130px 32px 40px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      {tab === "chat" && (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
          ...
          <div style={{ padding: "10px 16px 12px", background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 16, margin: "0 16px 12px", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <button style={{ width: 32, height: 32, borderRadius: "50%", background: C.tealLight, border: `1.5px solid ${C.teal}`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", fontSize: 15, flexShrink: 0 }}>🎙️</button>
          </div>
